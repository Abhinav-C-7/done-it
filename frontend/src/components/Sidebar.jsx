            ...
            <nav className="p-4">
                <ul className="space-y-4">
                    ...
                    {user && user.type === 'customer' && (
                        <li>
                            <Link to="/transactions" className="flex items-center text-gray-700 hover:text-yellow-600 p-2 rounded-lg hover:bg-yellow-50">
                                <svg className="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="ml-3 whitespace-nowrap hidden sidebar-text">
                    ...
                    {/* Notifications link - only for logged in users */}
                    {user && (
                        <li>
                            <Link to="/notifications" className="flex items-center text-gray-700 hover:text-yellow-600 p-2 rounded-lg hover:bg-yellow-50 relative">
                                <svg className="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
